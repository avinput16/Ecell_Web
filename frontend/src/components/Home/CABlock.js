...
import { Award, Gift, Rocket, Briefcase, Ticket } from 'lucide-react';
                ...
                >
                    ...
                    <div className="relative z-10 flex flex-col items-center text-center flex-1 max-w-2xl">
                        <div className="w-16 h-16 rounded-2xl bg-[#6b5fff]/10 flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300">
                            <Ticket size={32} className="text-[#6b5fff]" />
                        </div>
                        <h2 className="text-3xl md:text-5xl font-syne font-bold text-white mb-4">
                            Corporate <span className="text-[#CBF327]">Passes</span>
                        </h2>
                        <p className="text-white/60 text-base md:text-lg font-manrope mb-8 leading-relaxed">
                            Want to attend LAUNCHPAD with your team? Get your Corporate Passes — featuring <strong className="text-white">Highlight Speaker Sessions</strong>, <strong className="text-white">VC Meet & Greets</strong>, <strong className="text-white">Premium Networking Lunch</strong>, and exclusive <strong className="text-white">GOODies</strong>.
                        </p>
                        <div className="mt-auto">
                            <button
                                onClick={(e) => { e.stopPropagation(); navigate('/launchpad/corporate-passes'); }}
                            ...
                            >
                                Get Passes <Rocket size={20} />
                            </button>
                        </div>
                    </div>
                </motion.div>

                {/* Campus Ambassador Block */}
                <motion.div
                    initial={{ opacity: 0, y: 30 }}
                    whileInView={{ opacity: 1, y: 0 }}
